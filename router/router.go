...
func SetupRouter(mode string) *gin.Engine {
    ...
    auth.Use(middleware.VerifyTokenInWhitelist(http.StatusOK))
    {
        ...
        users.DELETE("/me", v1.DeleteUser)
        users.PUT("/me", v1.UpdateUserInfo)
        users.PUT("/me/password", v1.UpdatePassword)
        ...
        group.PUT("/:gid/applications", v1.Apply)
